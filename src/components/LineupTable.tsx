...
export const LineupTable: React.FC<LineupTableProps> = ({ lineup, players }) => {
  ...
  return (
    <div className="space-y-8">
      <div className="w-full overflow-x-auto bg-white rounded-2xl shadow-sm border border-black/5 p-6">
        <h2 className="text-2xl font-semibold mb-6 text-zinc-900">Game Lineup</h2>
